...
//                         sh 'echo $INTEGRATION_TESTS_ARGUMENTS'
                        ...
                        cd operations-center-it
                        ls -la ./casc-it/
                        mvn -pl casc-it $INTEGRATION_TESTS_ARGUMENTS -DOPERATIONS_CENTER_IT_CC_LOCATION=$(pwd)/casc-it/jenkins-oc.war -DOPERATIONS_CENTER_IT_OC_LOCATION=$(pwd)/casc-it/je.war $MAVEN_ARGS -Dmaven.test.failure.ignore=true verify "$@"
                        '''
